                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item">
                        <div class="d-flex weather-detail">
                            <span><i class="las la-cloud"></i>
                                <?php $rand = rand(28, 31); echo $rand;?>
                            </span>
                            Makassar, IDN
                        </div>
                    </li>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-1">Selamat datang dihalaman dashboard!</h6>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                            ...
                            <img src="{{ asset('admin/mophy.dexignzone.com/xhtml/images/avatar') }}/{{ Auth::user()->avatar }}" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
